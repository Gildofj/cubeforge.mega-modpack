; ==============================================================================
; CubeMegaMod - MASM x64 Native Hooks
; ==============================================================================
.code
...
; ------------------------------------------------------------------------------
; External Global Variables (Jump targets / Bails)
; ------------------------------------------------------------------------------
...
ASMTreasureFixHandler PROC
    ...
    RESTORE_STACK
    mov QWORD PTR [rsp + 60h], rax  ; Overwrite saved rcx on stack
    POP_ALL
    sub ecx, 1
    jz Label_TF_Ret1
    sub ecx, 1
